		...
		if (mouseIsPressed) {
			...
			//draw a line between them and the current positions
				...
				if (layer == "BaseLayer"){
					...
					botLayer.line(previousOppositeMouseX, previousOppositeMouseY, oX, oY);
					...
					var oX = this.calculateOpposite(mouseX, "x");
					var oY = this.calculateOpposite(mouseY, "y");
					middleLayer.line(previousOppositeMouseX, previousOppositeMouseY, oX, oY);
					previousOppositeMouseX = oX;
					previousOppositeMouseY = oY;
				}
					...
					var oX = this.calculateOpposite(mouseX, "x");
					var oY = this.calculateOpposite(mouseY, "y");
					topLayer.line(previousOppositeMouseX, previousOppositeMouseY, oX, oY);
					previousOppositeMouseX = oX;
					previousOppositeMouseY = oY;
				}
			}
